#ifndef TISRC_DATASTREAM_H
#define TISRC_DATASTREAM_H
...
struct datastream {
    ...
    union {
        ...
        struct {
            #if defined(TISRC_DATASTREAM_USESTDIO)
                FILE* f;
            #elif defined(TISRC_DATASTREAM_USESDL)
                SDL_RWops* rwo;
            #else
                int fd;
            #endif
...
#define TISRC_DATASTREAM_T struct datastream*

#else

#include <stdio.h>
#define TISRC_DATASTREAM_T FILE*
#define DS_END EOF
