...
bool startAudio(void) {
    ...
    if (tmp) {
        ...
        //inspec.freq = 22050;
        inspec.freq = 44100;
        #if !defined(TISRC_USESDL1) && PLATFORM != PLAT_EMSCR
    ...
    if (tmp) {
        ...
        #if !defined(TISRC_USESDL1) && (PLATFLAGS & PLATFLAG_UNIXLIKE) && defined(SDL_AUDIO_ALLOW_SAMPLES_CHANGE)
