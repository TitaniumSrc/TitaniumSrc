#ifndef TISRC_COMMON_CONFIG_H
#define TISRC_COMMON_CONFIG_H
...
struct cfg {
    ...
    #if !defined(TISRC_REUSABLE) && TISRC_MTLVL >= 2
    mutex_t lock;
    #endif
};

#ifndef TISRC_REUSABLE
    void cfg_open(TISRC_DATASTREAM_T, struct cfg*);
    void cfg_merge(struct cfg*, TISRC_DATASTREAM_T, bool overwrite);
#else
